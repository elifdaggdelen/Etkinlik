    ...
    public class ContactController : BaseController
    {
        ...
        public ActionResult Send(MailViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                message.From = new MailAddress("etkinlikelif@gmail.com", "Etkinlik E-Posta Servisi");
                message.To.Add(new MailAddress("elifdaggdelen@gmail.com"));
                ...
                try
                {
                    using (var smtp = new SmtpClient())
                    {
                        ...
                        {
                            UserName = "etkinlikelif@gmail.com",
